...
namespace Logbook\BackendBundle\Twig\Extension;

use Logbook\BackendBundle\Twig\Extension\LogbookExtension;
use Gedmo\Sluggable\Util\Urlizer;
use Symfony\Component\DependencyInjection\ContainerInterface;

class JavascriptExtension extends LogbookExtension
{
    const DELAY = 1000;
    const FADE_IN = 400;
    const FADE_OUT = 800;
    ...
    public function makeModal($id, $params = null)
    {
        ...
        $html = '<div id="'.$id.'" class="modal hide fade" tabindex="-1">
