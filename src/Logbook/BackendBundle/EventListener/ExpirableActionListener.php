<?php
namespace Logbook\BackendBundle\EventListener;
...
use Logbook\BackendBundle\Controller\ExpirableControllerInterface;
use Logbook\BackendBundle\Controller\BackendController;
