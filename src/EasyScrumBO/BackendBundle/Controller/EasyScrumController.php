...
class EasyScrumController extends Controller implements ExpirableControllerInterface
{
    ...
    {
        try {
            $restRequest=$this->get('guzzle.client')->get($this->container->getParameter('EasyScrumBO.rest.uri').'oauth/v2/token?client_id='.$this->container->getParameter('EasyScrumBO.rest.oauth.id').
                "&client_secret=".$this->container->getParameter('EasyScrumBO.rest.oauth.secret')."&grant_type=refresh_token&refresh_token=".
